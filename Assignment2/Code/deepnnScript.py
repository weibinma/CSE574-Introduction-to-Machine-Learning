...
def create_multilayer_perceptron():
    ...
    weights = {
        ...
        # 'h7': tf.Variable(tf.random_normal([n_hidden_7, n_hidden_7])),
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        print('epoch :', epoch, 'accuracy: ', accuracy.eval({x: test_features, y: test_labels}))
        acc_list.append(accuracy.eval({x: test_features, y: test_labels}))
